...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-gray-900 text-white pt-20 pb-2 mt-20">
      <div className="container mx-auto grid grid-cols-3 md:grid-cols-3 gap-15">
        <div>
      ...
      <p className="text-gray-400 pt-25">© 2024 Splash App. All rights reserved.</p>
    </footer>
  );
}
